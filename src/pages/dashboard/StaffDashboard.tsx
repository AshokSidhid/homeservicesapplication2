          ...
          <Card className="lg:col-span-1">
            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                <div className="w-24 h-24 rounded-full bg-blue-600 text-white flex items-center justify-center text-3xl mb-4">
                  {user.name.charAt(0)}
                </div>
                    ...
                    .map(booking => {
                      ...
                      return (
                        <div key={booking.id} className="flex justify-between items-center p-4 border border-gray-200 rounded-lg">
                          ...
                          <div>
                            <span className="px-3 py-1 rounded-full text-xs font-semibold capitalize bg-blue-100 text-blue-800">
                              {booking.status}
                            </span>
                          </div>
                        </div>
        ...
        <Card className="mb-8">
          <CardHeader className="bg-gray-50 flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex mt-3 sm:mt-0">
              <button
                className={`px-4 py-2 text-sm font-medium ${activeTab === 'upcoming' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'} rounded-l-md`}
                onClick={() => setActiveTab('upcoming')}
              >
                Upcoming
              </button>
              <button
                className={`px-4 py-2 text-sm font-medium ${activeTab === 'past' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'} rounded-r-md`}
